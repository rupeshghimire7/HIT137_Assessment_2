def verify_files(original_path, decrypted_path):
    try:
        ...
        raise FileNotFoundError(
            "Could not find the file: " + original_path
        )
    ...
    try:
        ...
        raise FileNotFoundError(
            "Could not find the file: " + decrypted_path
        )
    ...
    print("Decryption failed because the decrypted file is NOT the same as the original file.")
    return False
